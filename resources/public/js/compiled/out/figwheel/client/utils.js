...
return (new CustomEvent(event_name,(function (){var obj38768 = {"detail":data};
return obj38768;
})()));
} else {
...
var args38773 = [];
var len__25947__auto___38779 = arguments.length;
var i__25948__auto___38780 = (0);
while(true){
if((i__25948__auto___38780 < len__25947__auto___38779)){
args38773.push((arguments[i__25948__auto___38780]));

var G__38781 = (i__25948__auto___38780 + (1));
i__25948__auto___38780 = G__38781;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args38773.length)].join('')));
...
var f = (function (){var pred__38776 = cljs.core._EQ_;
var expr__38777 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__38776.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__38777))){
return ((function (pred__38776,expr__38777){
return (function (p1__38769_SHARP_){
return console.warn(p1__38769_SHARP_);
});
;})(pred__38776,expr__38777))
} else {
if(cljs.core.truth_(pred__38776.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__38777))){
return ((function (pred__38776,expr__38777){
return (function (p1__38770_SHARP_){
return console.debug(p1__38770_SHARP_);
});
;})(pred__38776,expr__38777))
} else {
if(cljs.core.truth_(pred__38776.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__38777))){
return ((function (pred__38776,expr__38777){
return (function (p1__38771_SHARP_){
return console.error(p1__38771_SHARP_);
});
;})(pred__38776,expr__38777))
} else {
return ((function (pred__38776,expr__38777){
return (function (p1__38772_SHARP_){
return console.log(p1__38772_SHARP_);
});
;})(pred__38776,expr__38777))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__38783){
...
var opts = map__38786__$1;
var eval_fn = cljs.core.get.call(null,map__38786__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__38788_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__38790,(0),null);
...
var args38793 = [];
var len__25947__auto___38796 = arguments.length;
var i__25948__auto___38797 = (0);
while(true){
if((i__25948__auto___38797 < len__25947__auto___38796)){
args38793.push((arguments[i__25948__auto___38797]));

var G__38798 = (i__25948__auto___38797 + (1));
i__25948__auto___38797 = G__38798;
continue;
} else {
}
break;
...
//# sourceMappingURL=utils.js.map?rel=1490248912149