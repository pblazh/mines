...
var len__25947__auto___44357 = arguments.length;
var i__25948__auto___44358 = (0);
while(true){
if((i__25948__auto___44358 < len__25947__auto___44357)){
args__25954__auto__.push((arguments[i__25948__auto___44358]));

var G__44359 = (i__25948__auto___44358 + (1));
i__25948__auto___44358 = G__44359;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__25955__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq44354){
var G__44355 = cljs.core.first.call(null,seq44354);
var seq44354__$1 = cljs.core.next.call(null,seq44354);
var G__44356 = cljs.core.first.call(null,seq44354__$1);
var seq44354__$2 = cljs.core.next.call(null,seq44354__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__44355,G__44356,seq44354__$2);
});
...
if(cljs.core.truth_((function (){var or__24872__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25478__auto__,writer__25479__auto__,opt__25480__auto__){
return cljs.core._write.call(null,writer__25479__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__24860__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__24860__auto__){
var or__24872__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__24872__auto__)){
return or__24872__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__44360_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__44360_SHARP_));
})))){
...
var map__44369 = opts;
var map__44369__$1 = ((((!((map__44369 == null)))?((((map__44369.cljs$lang$protocol_mask$partition0$ & (64))) || (map__44369.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44369):map__44369);
var markup_db = cljs.core.get.call(null,map__44369__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__24872__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e44373){var e__31698__auto__ = e44373;
return false;
}})();
if(cljs.core.truth_(or__24872__auto__)){
return or__24872__auto__;
...
}catch (e44375){var e__31698__auto__ = e44375;
return false;
}}
})())){
...
var _STAR_current_state_STAR_44380 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__44381 = opts;
var map__44381__$1 = ((((!((map__44381 == null)))?((((map__44381.cljs$lang$protocol_mask$partition0$ & (64))) || (map__44381.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44381):map__44381);
var markup_db = cljs.core.get.call(null,map__44381__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_44380;
}});
...
;
var temp__4655__auto___44386 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___44386)){
var managed_print_level_44387 = temp__4655__auto___44386;
var _STAR_print_level_STAR_44385_44388 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_44387;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_44385_44388,managed_print_level_44387,temp__4655__auto___44386,writer,opts,job_fn){
return (function (p1__44383_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__44383_SHARP_,null);
});})(_STAR_print_level_STAR_44385_44388,managed_print_level_44387,temp__4655__auto___44386,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_44385_44388;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1490248923146