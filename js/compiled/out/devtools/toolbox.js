...
var args44817 = [];
var len__25947__auto___44823 = arguments.length;
var i__25948__auto___44824 = (0);
while(true){
if((i__25948__auto___44824 < len__25947__auto___44823)){
args44817.push((arguments[i__25948__auto___44824]));

var G__44825 = (i__25948__auto___44824 + (1));
i__25948__auto___44824 = G__44825;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args44817.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox44820 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox44820 = (function (obj,header,style,tag,meta44821){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox44820.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_44822,meta44821__$1){
var self__ = this;
var _44822__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox44820(self__.obj,self__.header,self__.style,self__.tag,meta44821__$1));
});

devtools.toolbox.t_devtools$toolbox44820.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_44822){
var self__ = this;
var _44822__$1 = this;
return self__.meta44821;
});

devtools.toolbox.t_devtools$toolbox44820.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox44820.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox44820.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox44820.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox44820.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta44821","meta44821",-99168667,null)], null);
});

devtools.toolbox.t_devtools$toolbox44820.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox44820.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox44820";

devtools.toolbox.t_devtools$toolbox44820.cljs$lang$ctorPrWriter = (function (this__25478__auto__,writer__25479__auto__,opt__25480__auto__){
return cljs.core._write.call(null,writer__25479__auto__,"devtools.toolbox/t_devtools$toolbox44820");
});

devtools.toolbox.__GT_t_devtools$toolbox44820 = (function devtools$toolbox$__GT_t_devtools$toolbox44820(obj__$1,header__$1,style__$1,tag__$1,meta44821){
return (new devtools.toolbox.t_devtools$toolbox44820(obj__$1,header__$1,style__$1,tag__$1,meta44821));
});

}

return (new devtools.toolbox.t_devtools$toolbox44820(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1490248924247